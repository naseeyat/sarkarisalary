...
const { safeWriteFile, parseArgs, showHelp } = require('../../shared/generator-utils');
...
function generatePayCommissionPages() {
    ...
    Object.entries(commissions).forEach(([key, data]) => {
        ...
        const filepath = `../../pages/pay-scales/${filename}`;
        const args = parseArgs();
        safeWriteFile(filepath, pageContent, args.force);
    });
...
<body>
    <div class="container">
        ...
        <header class="header brutalist-header">
        ...
        <div class="pay-scale-table brutalist-table">
